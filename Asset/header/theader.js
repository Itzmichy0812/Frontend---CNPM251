function initProfilePanel() {
  ...
  profilePanel.innerHTML = `
    <div class="panel-header">
        <strong>[tên giảng viên]</strong><br>
        <span>Vai trò - Tutor</span>
    </div>
    <ul class="panel-menu">
        <li><a href="#" id="progress">Các khóa học của tôi</a></li>
        <li><a href="#" id="history">Lịch sử đăng ký lịch dạy</a></li>
        <li><a href="#" id="register">Đăng ký lịch dạy</a></li>
